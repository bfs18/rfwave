...
### TL;DR
RFWave is a diffusion-based vocoder. It can regenerate high-quality audio waveforms from Mel-spectrograms at a speed that is 90 times quicker than real-time on an Nvidia 4090. 
### Abstract
...
### Encodec Decoder
1. Train a Encodec Decoder `python3 train.py -c configs/rfwave-encodec.yaml`
### Text to Speech
