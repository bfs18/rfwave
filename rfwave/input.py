...
class AlignmentBlock(nn.Module):
    def __init__(self, dim, ctx_dim, num_proj_layers, attention_type='gaussian'):
        ...
        self.align_attn = CrossAttentionWithPrior(
            dim=args.dim, num_heads=args.n_heads, qkv_bias=False, qk_norm=args.qk_norm, attn_drop=args.dropout,
            proj_drop=args.dropout, norm_layer=RMSNorm, num_proj_layers=num_proj_layers, type=attention_type)
        self.adaLN_modulation = nn.Sequential(
